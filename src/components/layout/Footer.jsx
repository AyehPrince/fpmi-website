...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: "#1b3a4f" }}>
    ...
    <MessageCircle size={16} className="text-green-400 group-hover:text-white" />
          ...
          <div>
            ...
            <div className="mt-6 bg-[#f5c518] rounded-xl p-4">
              ...
              <Link href="/apply" className="block text-center bg-[#1b3a4f] text-white text-sm font-semibold py-2 rounded-lg hover:bg-[#1d4a63] transition-colors">
                Apply Now
              </Link>
            </div>
          </div>
