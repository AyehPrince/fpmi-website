    ...
    <section className="relative min-h-screen md:min-h-screen flex items-center justify-center overflow-hidden py-32 md:py-0">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          priority
        />
        {/* Dark navy overlay — keeps text readable, image is subtle */}
        <div className="absolute inset-0 bg-[#0a0f5c]/90" />
        {/* Extra gradient on top for depth */}
        <div
          className="absolute inset-0"
          style={{
            background: "linear-gradient(135deg, rgba(10,15,92,0.75) 0%, rgba(10,15,92,0.55) 50%, rgba(10,15,92,0.85) 100%)"
          }}
        />
        {/* Subtle gold and cyan glow — same as before */}
        <div
