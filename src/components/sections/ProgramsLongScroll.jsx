          ...
          <div className="relative p-7 md:p-9">
            ...
            >
              ...
              <Link
                ...
                style={{ backgroundColor: "#0a0f5c", color: "#fff" }}
              >
                Full Details
                <span
...
export default function ProgramsLongScroll() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#f8f9fc" }}>
      ...
      {/* ── HERO ── */}
      <div className="relative overflow-hidden" style={{ backgroundColor: "#0a0f5c" }}>
            ...
            <div className="flex flex-wrap gap-3">
              {NAV_LINKS.map((link) =>
                link.href.startsWith("#") ? (
                  ...
                  >
                    {link.label}
                    <span className="w-5 h-5 rounded-full bg-[#0a0f5c]/10 flex items-center justify-center group-hover:translate-x-0.5 transition-transform duration-300">
                      <ArrowRight size={10} />
                    </span>
                  </Link>
                )
      ...
      {/* ── ADMISSION ── */}
      <section id="admission" style={{ backgroundColor: "#0a0f5c" }}>
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link
                href="/contact"
                className="px-7 py-3.5 rounded-full font-bold text-sm border-2 border-[#0a0f5c]/20 text-[#0a0f5c] hover:border-[#0a0f5c] transition-all duration-300"
              >
                Contact Admissions
              </Link>
            </div>
