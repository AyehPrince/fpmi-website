export const programs = [
  ...
  },
  {
    ...
    courses: [
      ...
      "News Reporting",
      "Sports Presenting",
      "Program Hosting (Talk Show/Interview)",
      "Disk Jockey (DJ)",
  ...
  },
  {
    ...
    accentColor: "#f59e0b",
    shortDescription: "Hands-on training in film production, camera handling, cinematography, lighting and video editing.",
    fullDescription: "The Media Arts Production program is an intensive practical course that transforms beginners into competent media production professionals ready for broadcast and film environments. Students learn everything from camera mechanics to advanced cinematography, lighting, editing and directing. With hands-on training in our professional studios and on location, graduates leave with a strong reel and the technical skills to work in any production environment.",
    whatYouLearn: [
    ...
    courses: [
      ...
      "Film & Video Editing",
      "Cinematography",
      "Camera Handling (Videography/Photography)",
      "Lighting",
      "Graphic Design",
      "Script Writing / Acting / Directing / Producing",
    ],
  },
  {
    slug: "graphic-design",
  ...
  },
  {
    ...
    careerOpportunities: [
      ...
      "Pastry Chef / Baker",
      "Buffet and Banquet Supervisor",
      "Independent Culinary Entrepreneur",
    ...
    courses: [
      ...
      "Table Settings & Fine Dining Etiquette",
      "Baking & Pastry Arts",
